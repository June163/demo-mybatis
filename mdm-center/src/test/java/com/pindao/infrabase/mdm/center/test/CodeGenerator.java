package com.pindao.infrabase.mdm.center.test;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/mdm-core/src/main/java");
        ...
        pc.setParent("com.pindao.infrabase.mdm.core.area.domain.model");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/mdm-core/src/main/resources/mapper/core/" + pc.getModuleName()
